# -*- coding: utf-8 -*-
"""
Created on Wed Apr 21 17:20:49 2021
...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def initializeGL(self):
        ...
        self.shape2 = self.make_shape()
        self.shape3 = self.make_shape()
        self.shape4 = self.make_shape()
    ...
    def paintGL(self):
        ...
        glPushMatrix()
        self.draw_shape(self.shape1, 0.0, 0.0, 0.0,
            (self.x_shape_rot, self.y_shape_rot, self.z_shape_rot))
        
        self.draw_shape(self.shape2, 2.0, 0.0, 0.0,
            (self.x_shape_rot, self.y_shape_rot, self.z_shape_rot))
        
        
        self.draw_shape(self.shape3, 2.0, -2.0, 0.0,
            (self.x_shape_rot, self.y_shape_rot, self.z_shape_rot))

        
        self.draw_shape(self.shape4, 2.0, 2.0, 0.0,
            (self.x_shape_rot, self.y_shape_rot, self.    ))
        glPopMatrix()
